...
<template>
  <main>
    <BlockContainer title="Цвета">
      <ColorPalete/>
    </BlockContainer>
    <BlockContainer title="А тута Popup">
      <button @click="popupOpen = !popupOpen" class="warning">Открыть</button>
      <button @click="popupOpen = !popupOpen" class="error">Открыть</button>
